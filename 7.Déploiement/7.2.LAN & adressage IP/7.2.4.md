---
title: 4. DHCP statique/dynamique ; IPv6 (aperçu)
layout: home
nav_order: 4
...
ua: "7.2.U2"
duree_h: 1.5
objectif: "Mettre en place DHCPv4 (pools, réservations, options), configurer un relay et comprendre SLAAC/DHCPv6."
notions_nouvelles: ["DHCP DORA", "Options 1/3/6/15/51", "Réservation MAC→IP", "DHCP Relay/Helper", "IPv6 SLAAC/DHCPv6", "ULA/GUA/Link-local"]
fil_rouge: "Attribution IP multi-VLAN via relay"
livrable_chapitre: "Plan DHCP (pools/réservations/options) + schéma relay + journal release/renew"
alimentation_prototype: "Adressage automatique fiable"
alimentation_miniprojet: "Gestion des baux et IP stables pour équipements"
---

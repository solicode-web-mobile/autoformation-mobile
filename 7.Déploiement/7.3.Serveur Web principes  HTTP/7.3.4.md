...
ua: "7.3.U5"
duree_h: 1.5
objectif: "Lire, filtrer et corréler les logs Apache access/error avec rotation logrotate."
notions_nouvelles: ["access.log", "error.log", "LogFormat", "ErrorLog/LogLevel", "Rotation", "GoAccess"]
fil_rouge: "Suivi des requêtes API/blog et diagnostics erreurs"
livrable_chapitre: "Extraits vhost (CustomLog/ErrorLog), commandes awk/grep, fichier logrotate"
alimentation_prototype: "Suivi codes/statuts pour debug rapide"
alimentation_miniprojet: "Logs séparés + rotation pour exploitation"
---
...
### 3.4 Répertoires & permissions (Linux)
...
* Ouvrir **80** (HTTP) et **443** (HTTPS) côté serveur.

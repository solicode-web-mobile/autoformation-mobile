...
permalink: /http-principes/tracage/
code: 7.3.6
competence: C7
autoformation: "C7.3"
ua: "7.3.U3"
duree_h: 2
objectif: "Tracer une requête du client à l’application et identifier l’étage lent ou en panne."
notions_nouvelles: ["TTFB", "Request ID", "Hop réseau", "Handshake TLS", "Upstream (PHP-FPM, DB)"]
fil_rouge: "Diagnostic complet requête blog/API jusqu’à la base"
livrable_chapitre: "Captures DevTools + sortie curl -w + logs avec Request ID"
alimentation_prototype: "Corrélation simple client→Apache→PHP"
alimentation_miniprojet: "Runbook diagnostic bout-à-bout en production"
---

---
title: 6. Gestion d’erreurs réseau

permalink: /android-api-retrofit/errors-snackbar-timeouts/
layout: home
nav_order: 6
parent: 5.4. Consommer une API
---

# 📘 Chapitre 5.4.6 — Gestion d’erreurs réseau 
...
**Mapping des exceptions → `NetError`**
...
**Mapper l’erreur vers un message utilisateur**

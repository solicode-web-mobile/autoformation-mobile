---
title: 5. ViewModel, état immuable et intents d’actions
permalink: /android-compose-mvvm/viewmodel-ui-state-intents/
layout: home
nav_order: 5
...
> 🔒 `val` + **`copy`** pour chaque mise à jour → pas de mutation surprenante.
